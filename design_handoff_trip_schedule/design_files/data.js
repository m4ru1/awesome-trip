/* ============================================================
   旅行课程表 · 样例数据：京都赏枫 5 日
   一份稳定的 Trip 对象，所有视图共用。
   ============================================================ */
(function () {
  // 小工具：生成 OptionCard
  function opt(o) { return Object.assign({ tags: [] }, o); }
        ...
        blocks: [
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "train", cost: "¥150", duration: "12min", distance: "4.2km", note: "JR奈良线 → 京都站换乘，班次密集" },
          ...
          },
          {
            ...
            alternatives: [
              opt({ id: "o-sushi", name: "musashi 回转寿司", emoji: "🍣", cuisine: "回转寿司", perPersonCost: "¥1,100",
                budgetLevel: 1, signatureDishes: ["金枪鱼", "玉子"], reservationNeeded: false,
                highlight: "人均一百出头，快又稳，省下的钱留给晚餐。", tags: ["平价", "快"], swapReason: "save" })
            ],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "6min", distance: "450m", note: "穿过新京极商店街" }, alternatives: [] }
          },
          {
            ...
            alternatives: [
              opt({ id: "o-sennyuji", name: "泉涌寺 御座所庭园", emoji: "🍂", openHours: "09:00–16:30", ticketPrice: "¥500",
                suggestedDuration: "1.5 小时", highlight: "皇室香火寺，红叶安静、几乎没有人挤。",
                tags: ["小众", "清净"], swapReason: "closed" })
            ],
            transportToNext: { primary: { mode: "bus", cost: "¥230", duration: "22min", distance: "5.8km", note: "207路 → 清水道下车" },
          ...
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "10min", distance: "750m", note: "沿宁宁之道散步下山" }, alternatives: [] }
          },
          {
            ...
            alternatives: [
              opt({ id: "o-ramen", name: "猪一 鸡白汤拉面", emoji: "🍜", cuisine: "拉面", perPersonCost: "¥1,400",
            ...
            transportToNext: { primary: { mode: "taxi", cost: "¥1200", duration: "10min", distance: "3km", note: "夜间走路也行，约 25 分钟" }, alternatives: [
              { mode: "walk", cost: "免费", duration: "25min", distance: "2km", note: "沿鸭川夜色散步" } ] }
          },
          {
        ...
        blocks: [
          {
            ...
            alternatives: [
              opt({ id: "o-fukuda", name: "福田美术馆", emoji: "🖼️", openHours: "10:00–17:00", ticketPrice: "¥1,500",
                suggestedDuration: "1.5 小时", highlight: "临渡月桥的精致美术馆，下雨天躲进来看画看河景。",
                tags: ["室内", "看河景"], swapReason: "rain" })
            ],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "8min", distance: "600m", note: "竹林尽头即天龙寺北门" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "5min", distance: "350m", note: "门口就是嵯峨豆腐街" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "train", cost: "¥240", duration: "30min", distance: "9km", note: "嵯峨岚山站 → 圆町，换巴士" },
          ...
          },
          {
            ...
            alternatives: [
              opt({ id: "o-museum", name: "京都国立博物馆", emoji: "🏛️", openHours: "09:30–17:00", ticketPrice: "¥700",
                suggestedDuration: "2 小时", highlight: "全室内，雨天看国宝特展，慢慢逛不淋雨。",
                tags: ["室内", "看展"], swapReason: "rain" })
            ],
            transportToNext: { primary: { mode: "bus", cost: "¥230", duration: "35min", distance: "7km", note: "市巴士 → 四条河原町，可能拥挤" },
          ...
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "7min", distance: "500m", note: "走到先斗町一带" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "9min", distance: "700m", note: "沿木屋町回旅宿" }, alternatives: [] }
          },
          {
            ...
            alternatives: [], transportToNext: null
          }
        ]
      },
        ...
        blocks: [
          {
            ...
            alternatives: [
              opt({ id: "o-shisendo", name: "诗仙堂", emoji: "🍂", openHours: "09:00–17:00", ticketPrice: "¥700",
                suggestedDuration: "1.25 小时", highlight: "离市区近得多，省下来回两小时车程。",
                tags: ["省时", "近市区"], swapReason: "time" })
            ],
            transportToNext: { primary: { mode: "bus", cost: "¥390", duration: "45min", distance: "16km", note: "大原 → 出町柳，山路班次较少" },
          ...
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "12min", distance: "900m", note: "过鸭川三角洲跳石" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "30min", distance: "2km", note: "哲学之道散步过去" },
          ...
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "subway", cost: "¥220", duration: "15min", distance: "3.5km", note: "蹴上站 → 三条" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "10min", distance: "750m", note: "散步回旅宿" }, alternatives: [] }
          },
          {
        ...
        blocks: [
          {
            ...
            alternatives: [
              opt({ id: "o-shinsen", name: "神泉苑 + 二条商圈", emoji: "🌿", openHours: "07:00–20:00", ticketPrice: "免费",
                suggestedDuration: "45 分钟", highlight: "周一二条城若闭馆，旁边的神泉苑小巧免费。",
                tags: ["免费", "备用"], swapReason: "closed" })
            ],
            transportToNext: { primary: { mode: "subway", cost: "¥260", duration: "18min", distance: "5km", note: "东西线 → 乌丸御池换乘" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "train", cost: "¥410", duration: "40min", distance: "15km", note: "JR → 宇治站" },
          ...
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "train", cost: "¥410", duration: "40min", distance: "15km", note: "JR 宇治 → 京都站" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "8min", distance: "500m", note: "站内步行到空中走廊" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "12min", distance: "900m", note: "走回旅宿收行李" }, alternatives: [] }
          },
          {
        ...
        blocks: [
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "subway", cost: "¥220", duration: "12min", distance: "3km", note: "乌丸线 → 今出川" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "walk", cost: "免费", duration: "10min", distance: "750m", note: "走到二条城旁咖啡馆" }, alternatives: [] }
          },
          {
            ...
            alternatives: [],
            transportToNext: { primary: { mode: "taxi", cost: "¥1300", duration: "12min", distance: "3.5km", note: "回旅宿取行李" }, alternatives: [] }
          },
          {
  ...
  window.TRIP_DATA = TRIP;
  window.TYPE_META = TYPE_META;
  window.TRANSPORT_META = TRANSPORT_META;
  window.SCENARIO_META = SCENARIO_META;
})();
